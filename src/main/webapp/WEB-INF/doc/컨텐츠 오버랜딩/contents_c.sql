...
SELECT contentsno, adminno, cateno, title, content, recom, cnt, replycnt, word, rdate,
           file1, file1saved, thumb1, size1, map, youtube
FROM contents
WHERE cateno=2 AND word LIKE '%탐험%'
ORDER BY contentsno DESC;
...
SELECT contentsno, adminno, cateno, title, content, recom, cnt, replycnt, word, rdate,
           file1, file1saved, thumb1, size1, map, youtube
FROM contents
WHERE cateno=2 AND (title LIKE '%급여%' OR content LIKE '%급여%' OR word LIKE '%급여%')
ORDER BY contentsno DESC;
...
SELECT COUNT(*) as cnt
FROM contents
WHERE cateno=2 AND word LIKE '%급여%';
...
SELECT contentsno, adminno, cateno, title, content, recom, cnt, replycnt, rdate,
           file1, file1saved, thumb1, size1, map, youtube
FROM contents
WHERE cateno=2 AND (title LIKE '%탐험%' OR content LIKE '%탐험%' OR word LIKE '%탐험%')
ORDER BY contentsno DESC;
...
FROM (
           ...
           FROM (
                     SELECT contentsno, adminno, cateno, title, content, recom, cnt, replycnt, rdate,
                                file1, file1saved, thumb1, size1, map, youtube
                     FROM contents
                     WHERE cateno=1 AND (UPPER(title) LIKE '%' || UPPER('탐험') || '%' 
...
FROM (
           ...
           FROM (
                     SELECT contentsno, adminno, cateno, title, content, recom, cnt, replycnt, rdate,
                                file1, file1saved, thumb1, size1, map, youtube
                     FROM contents
                     WHERE cateno=2 AND (UPPER(title) LIKE '%' || UPPER('탐험') || '%' 
                                         OR UPPER(content) LIKE '%' || UPPER('탐험') || '%' 
                                         OR UPPER(word) LIKE '%' || UPPER('탐험') || '%')
                     ORDER BY contentsno DESC
           )          
