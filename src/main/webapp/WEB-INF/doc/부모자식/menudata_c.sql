...
CREATE TABLE MENUDATA(
    ...
    FOREIGN KEY (MENUCATENO) REFERENCES MENUCATE (MENUCATENO)
);

COMMENT ON TABLE MENUDATA is '메뉴 정보';
COMMENT ON COLUMN MENUDATA.MENUDATANO is '메뉴 그룹 번호';
COMMENT ON COLUMN MENUDATA.MENUCATENO is '분류명';
...
INSERT INTO MENUDATA (MENUDATANO, MENUCATENO, title, rdate)
...
MENUDATANO MENUCATENO TITLE                          RDATE              
---------- ---------- ------------------------------ -------------------
