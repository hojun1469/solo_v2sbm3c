...
<c:import url="/menu/top.do" />
  ...
  <aside class="aside_right">
    ...
    <span class='menu_divide' >│</span>    
    <a href="./list_by_cateno.do?cateno=${param.cateno }&now_page=${param.now_page == null ? 1 : param.now_page }&word=${param.word }">목록형</a>    
    <span class='menu_divide' >│</span>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <c:forEach var="contentsVO" items="${list }" varStatus="info">
          ...
          <tr onclick="location.href='./read.do?contentsno=${contentsno}&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }&cateno=${param.cateno }'" style="cursor: pointer;">
            <td>
              <c:choose>
            ...
            <td class="td_bs">
              <a href="/contents/map.do?cateno=${cateno }&contentsno=${contentsno}&now_page=${param.now_page}" title="지도 설정"><img src="/contents/images/map.png" class="icon"></a>
              <a href="/contents/youtube.do?cateno=${cateno }&contentsno=${contentsno}&now_page=${param.now_page}" title="Youtube 설정"><img src="/contents/images/youtube.png" class="icon"></a>
              <a href="/contents/delete.do?cateno=${cateno }&contentsno=${contentsno}&now_page=${param.now_page}" title="삭제"><img src="/contents/images/delete.png" class="icon"></a>
            </td>
          </tr>
        </c:forEach>
    </tbody>
