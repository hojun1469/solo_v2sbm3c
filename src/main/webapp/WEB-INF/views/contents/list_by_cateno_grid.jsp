...
<c:import url="/menu/top.do" />
  ...
  <aside class="aside_right">
    ...
    <span class='menu_divide' >│</span>
    <a href="./list_by_cateno_grid.do?cateno=${param.cateno }&now_page=${param.now_page}&word=${param.word }">갤러리형</a>    
  </aside>
  ...
  <div style='width: 100%;'> <%-- 갤러리 Layout 시작 --%>
    <c:forEach var="contentsVO" items="${list }" varStatus="status">
      ...
      <div onclick="location.href='./read.do?contentsno=${contentsno}&word=${param.word }&now_page=${param.now_page == null ? 1 : param.now_page }&cateno=${param.cateno }'" 
